    ...
    <nav class="navbar navbar-expand-lg navbar-dark w-100 py-3" style="background:#3366FF">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <a class="navbar-brand m-0 ml-2 p-0" href="#">
                ...
                <a class="nav-link text-white" href="{{ url('/loginCliente') }}">{{ __('IniciarSesion/Registrarse') }}</a>
        ...
        <button class="btn btn-outline-light mx-2 p-0 border-0 position-relative d-inline-block" href="#">
            ...
            <span class="badge badge-light position-absolute">4</span>
        </button>
