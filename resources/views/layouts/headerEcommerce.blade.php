...
<div class="row" id="header">
    <nav class="navbar navbar-expand-lg navbar-dark col-md-12 px-0 py-0" style="background:#3366FF">
        <div class="row col-12 my-0 mx-auto col-md-12 py-0 p-md-1">
            <button class="navbar-toggler col-2 my-3 mx-0 p-0 border" type="button" data-toggle="collapse" data-target="#collapseSubtitulo" aria-controls="collapseSubtitulo" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <a class="navbar-brand col-5 col-md-auto mx-0 mx-md-auto px-1 py-1 py-md-1 px-md-1 my-auto" href="{{url('/')}}">
            ...
            <div class="col my-auto d-none d-md-block">
                <div class="input-group my-auto">
                    <input class="form-control" type="search" placeholder="Buscar producto" name="buscar" id="buscar" aria-label="Buscar producto" autocomplete>
                    <div class="input-group-append">
                        <img src="{{ asset('img\search.svg') }}" for="buscar" class="btn btn-secondary p-1" width="30px" height="100%" alt="buscador" onclick="buscarProducto('buscar')">
                    </div>
                </div>
                <div class="col ml-auto mr-0 px-0 position-relative">
                    <div class="card card-body col-12 position-absolute collapse mx-0 shadow-lg" id="collapseBuscar" style="z-index:10;">
            ...
            <div class="dropdown col-3 col-sm-2 col-md-1 my-auto">
                <a id="invitadoDropdown" class="nav-link dropdown-toggle p-1 p-sm-3 p-md-0 p-lg-1 p-xl-3 text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{ asset('img\usuario.png') }}" alt="LOGO" class="img-fluid" href="{{ url('/loginCliente') }}">
                </a>
            ...
            @else
            <div class="dropdown col-3 col-sm-2 col-md-1 my-auto">
                <a id="navbarDropdown" class="nav-link dropdown-toggle p-1 p-sm-3 p-md-0 p-lg-1 p-xl-3 text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-2 col-md-auto p-0 my-3 p-md-3 mx-md-2 my-md-auto">
                <button class="btn btn-outline-light position-relative border-0" data-toggle="collapse" data-target="#collapseCarrito" aria-expanded="false" aria-controls="collapseCarrito">
                    <!--img src="{ asset('img\carritoCompras.png') }}" class="" alt="CARRITO" height="40px"-->
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="img-fluid bi bi-cart3" viewBox="0 0 16 16">
    ...
    <div class="row col-12 my-0 mx-0 px-0 py-2 d-block d-md-none border border-primary">
        <div class="input-group col-12 mx-auto my-auto">
            <input class="form-control" type="search" placeholder="Buscar producto" name="buscar1" id="buscar1" aria-label="Buscar producto" autocomplete>
            <div class="input-group-append">
                <img src="{{ asset('img\search.svg') }}" for="buscar" class="btn btn-success p-1" width="30px" height="100%" alt="buscador" onclick="buscarProducto('buscar1')">
            </div>
        </div>
    </div>
    <script>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark col-12 mx-0 my-0 py-0 py-md-1 position-relative" style="background:#BDC2C5">
        <div class="collapse navbar-collapse" id="collapseSubtitulo">
            <div class="row col-auto my-1 mx-auto mx-md-1 p-1 p-md-0 border border-light">
                <img src="{{ asset('img\ubicacion.png') }}" alt="UBICACION" class="col-2 col-md-1 my-auto p-2 p-md-1 img-fluid">
            ...
            @if($count < 3) <ul class="navbar-nav mx-auto btn-outline-info d-none d-md-block">
                <li class="nav-item">
                    <a class="nav-link text-dark" href="{{url('/departamento/'.$departamento->id)}}">{{$departamento->nombre}}<span class="sr-only">(current)</span></a>
                </li>
                </ul>
                @php $count++ @endphp
...
<div class="position-fixed bottom-0 right-0 p-3" style="z-index: 5; right: 0; bottom: 0;">
    <div id="toastAgregarCarrito" class="toast hide bg-primary" role="alert" aria-live="assertive" aria-atomic="true" data-delay="3500">
        ...
        <div class="toast-body">
            <p class="h5 text-white" id="toastCuerpoCarrito">
            <p>
        </div>
    </div>
</div>
<script>
    ...
    $('#buscar').bind('keyup', function(evt) {
        if ($(this).val().length > 0) {
            fetch(`{{url('/busquedaTiempoReal')}}?buscar=${$(this).val()}`, {
                    method: 'get'
                })
                ...
                .then(obj => {
                    ...
                    {
                        cuerpo = cuerpo + `<a class="nav-link" href="{{url('/producto')}}/${obj.body[i].id}">${obj.body[i].nombre}</a>`;
                    }
                    $('#collapseBuscar').html(
                        //$('#buscar').val()
                        cuerpo
