                    ...
                    <div class="row mx-1 mb-2 py-2 border border-secondary">
                        ...
                        <div class="col-2 form-group row m-auto">
                            <div class="input-group">
                                ...
                                <input type="number" id="inputIva" data-prefix="IVA %" name="inputIva" value=16 min=0 class="form-control my-auto" />
                            </div>
                        </div>
                        <div class="col-4 form-group row m-auto">
                            ...
                            <div class="col-auto ml-auto px-1 py-0 border border-secondary rounded">
                                <div class="form-check my-1">
                                    <input type="checkbox" name="credito" id="credito" class="form-check-input mt-2" onchange="activarCredito()" />
                            ...
                            <div class="col-8 mr-auto px-0">
                                <input type="number" data-prefix="ABONO $" id="pagoCredito" name="pagoCredito" data-decimals="2" value=0 min=0 class="form-control px-0" />
                            </div>
                        </div>
                    </div>
                    <div class="row ml-1">
                        <button type="button" class="btn btn-secondary my-auto " data-toggle="modal" data-target="#exampleModal" onclick="buscarProducto()">
        ...
        <div class="modal-content" id="modalConsulta">
            ...
            <div class="modal-body" id="cuerpoModal">
                <div class="row">
                    ...
                    <input type="text" class="form-control mx-2 mb-3 text-uppercase" placeholder="Buscar producto" id="busquedaProducto" onkeyup="buscarProducto()">
                </div>
