                ...
                <div class="col-12">
                    ...
                    <div class="form-inline ml-1 mr-1 mb-2">
                        ...
                        <div class="form-group border border-secondary my-auto mx-auto p-1">
                            ...
                            <input type="number" id="inputIva" data-prefix="%" name="inputIva" value=16 min=0 class="form-control" />
                            <!--/div-->
                        </div>
                        <div class="form-group border border-secondary my-auto ml-auto p-1">
                            ...
                            <div class="input-group my-0 mx-auto px-0" id="formCredito">
                                ...
                                <input type="number" data-prefix="$" id="pagoCredito" name="pagoCredito" data-decimals="2" value=0 min=0 class="form-control" />
                            </div>

                        </div>
                    </div>
                    <div class="row ">
                        <button type="button" class=" row  btn btn-outline-primary ml-2 my-auto " data-toggle="modal" data-target="#exampleModal" onclick="buscarProducto()">
