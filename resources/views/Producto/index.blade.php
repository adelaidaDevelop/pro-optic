...
<!--MODAL SUBPRODUCTO-->
<div class="modal fade modal_Exis_Nuevo" id="modal_Exis_Nuevo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-small " role="document">
        <div class="modal-content" style="width:500px;">
            <div class="modal-header  ">
                <!--ENCABEZADO -->
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btnNueva_Exis_Sub" onclick="agregarSubprod();">GUARDAR</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCELAR</button>
            </div>
        </div>
    </div>
