                    ...
                    if (productos[count10].id === id) {
                        ...
                        let botonesProducto = `<a class="btn btn-outline-primary mb-2 " href="{{ url('/puntoVenta/producto/` + x + `/edit')}}" onclick="return confirm('¿EDITAR ESTE PRODUCTO?')"> 
                                           ...
                                           EDITAR COSTO
                                            ...
                                            <br/>`;
                                            let btnDarBaja=`<a class="btn btn-outline-danger mb-2 mt-4" data-method="delete" onclick="return confirm('¿DESEA DAR DE BAJA ESTE PRODUCTO?')"  href="{{ url('/puntoVenta/productoEli3/` + x + `', [` + x + `])}}"> 
