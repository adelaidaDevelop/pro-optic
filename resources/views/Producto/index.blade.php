                                ...
                                <fieldset disabled id="formEditar">
                                    <form id="editarProducto">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <input type="number" name="minimoStock" id="minimoStock" 
                                                class="form-control text-uppercase" placeholder="Ingrese el minimo 
                                                de productos permitidos" value="${ms}" autofocus required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">      
                                                <input type="number" name="costoNuevo" id="costoNuevo" class="form-control"
                                                placeholder="COSTO NUEVO" onkeypress="return filterFloat(event,this);" 
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">  
                                                <input type="number" name="precioNuevo" id="precioNuevo" class="form-control"
                                                placeholder="PRECIO NUEVO" onkeypress="return filterFloat(event,this);"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">              
                                                ...
                                                placeholder="CANTIDAD DE PRODUCTO" onkeypress="return filterFloat(event,this);"
