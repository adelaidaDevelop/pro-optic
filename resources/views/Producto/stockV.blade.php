        ...
        <div class="input-group col-8 mx-auto">
            ...
            <div class="input-group-appendborder">
                <button class="btn text-dark border p-0" onclick="buscarProducto()">
                    <img src="{{ asset('img\busqueda.png') }}" class="img-thumbnail m-0" alt="Regresar" width="38px"
                        height="38px" /></button>
            </div>
        </div>
...
async function buscarProducto() {
    try {
        ...
        if (cuerpo == "") {
            ...
            let sin =
                ` <h5 class= "text-dark my-auto  mt-4 "> TODOS LOS PRODUCTOS SE HAN AGREGADO ESTA SUCURSAL</h5>`;
