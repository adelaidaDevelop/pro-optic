...
<div class="row col-12 mx-0 px-0">
    <div class="row col-md-9 mx-auto px-1 py-1 mb-auto border-bottom border-dark ">
        <div class="col-2 col-md-1 my-auto my-md-1 mx-md-auto px-0 py-0">
            <img class="col-md-10 mx-auto my-0 img-fluid" src="{{ asset('img\dar_alta.png') }}" alt="FORMA DE PAGO" />
        </div>
    ...
    <div class="row col-12 mx-auto mt-1  mb-4  ">
        <div class="row col-12 mx-auto px-0 mb-auto">
            <div class="col-3 col-md-1 my-1 mx-0 px-0">
                <img class="col-10 mx-0 img-fluid" src="{{ asset('img\sonrisa.png') }}" alt="UBICACION" />
            </div>
            <h4 class="row col-auto my-auto px-0 text-success text-left">Farmacias Gi agradece su preferencia. Su pedido se ha generado exitosamente.</h4>
        </div>
    </div>

    <div class="row col-12 mx-auto mt-1  mb-4  ">
        <div class="row col-12 mx-auto px-0 mb-auto">
            <h5 class="row col-auto my-auto px-0 text-secondary text-left"><small><strong> La solicitud de compra se ha enviando a la sucursal de Farmacias Gi elegida para su verificación y aprobación. En caso de aclaración sobre su pedido, empleados de Farmacias Gi, se estarán comunicando vía telefónica con usted.</strong> </small> </h5>
        </div>
    </div>
...
<div class="row col-12 mx-0 mt-4 mb-1 px-0">
    ...
    <div class="col-12 text-right  text-center mx-auto my-md-4 alert-warning">
        <p class="h6 ">
