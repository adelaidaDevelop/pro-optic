        ...
        <div class="accordion mb-2" id="filtrarPorCategoria">
            <div class="card">
                <div class="card-header p-0" id="headingOne">
                    <h2 class="mb-0">
                        <button class="btn btn-light btn-block text-left text-success font-weight-bolder" type="button"
                            data-toggle="collapse" data-target="#collapseDepartamento" aria-expanded="true"
                ...
                <div id="collapseDepartamento" class="collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{$departamento->id}}"
                                id="check{{$departamento->id}}" name="check{{$departamento->id}}" onchange="filtrar()">
                            <label class="form-check-label" for="check{{$departamento->id}}">
                                {{$departamento->nombre}}
                            </label>
                        </div>
                        @endforeach
            ...
            <div class="card">
                ...
                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="500" id="rango2"
                                onchange="filtrar()">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="501" id="rango3"
                                onchange="filtrar()">
