    ...
    <div class="row border border-dark m-2 ml-4 mr-4 col ">
        ...
        <div class="col mt-1 mb-4 ml-4 mr-4">
            <div class="row  px-0 col-8 input-group my-4">
                ...
                <input type="number" min=0 class="form-control col-4 my-auto ml-3" size="15"
                    placeholder="INGRESAR FOLIO VENTA" id="busquedaFolio" name="busquedaFolio" onkeyup="buscarFolio()">
                <a title="buscar" class="text-dark ml-2 mr-5 my-auto">
                    <img src="{{ asset('img\search.svg') }}" class="img-thumbnail" alt="Regresar" width="40px"
                        height="40px" /></a>
                <div class="col-2 ml-5"> </div>
                <button class=" btn btn-outline-info my-auto " onclick="modalVenta()" data-toggle="modal"
                    data-target="#buscarVenta" type="button">
                    BUSCAR VENTA
                    <img src="{{ asset('img\busqueda.png') }}" class="img-thumbnail" alt="Regresar" width="35px"
                        height="35px" />
                </button>
            </div>
