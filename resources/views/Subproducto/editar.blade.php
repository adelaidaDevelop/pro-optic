...
<body>
<form method="post" action="{{url('/subproducto/'.$subproducto->idProductos)}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{method_field('PATCH')}}
        <br/> <br/>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8" style="background:#D5DBDB">
                <h5 class="blockquote text-center"> <strong>Editar subproducto</strong></h5>
            </div>
            <div class="col-md-2"> </div>
        </div>
        <br/>
