            ...
            <div class="col-8">
                ...
                <div class=" row">
                    ...
                    <div class="col-3">
                        ...
                        <input class="form-control mt-3" type="number" id="precio" name="precio" data-decimals="2" min="0" step="0.01" placeholder="PRECIO INDIVIDUAL4" value="{{ isset($subproducto->precio)?$subproducto->precio:''}}" required>
