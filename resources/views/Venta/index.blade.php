        ...
        <div class="col-12">
            <div class="row mx-0 mt-2 mb-1 px-0">
                ...
                <div class="form-group row col-9 my-1 mx-0 px-0">
                    ...
                    <div class="col-3">
                        <button class="btn btn-primary form-control" type="button" style="background-color:#3366FF" onclick="agregarPorCodigo()" value="informacion" id="botonAgregar">
                            <img src="{{ asset('img\agregar.png') }}" class="img-thumbnail" alt="Editar" width="25px" height="25px">
                            AGREGAR
                        </button>
                    </div>
            ...
            <div class="row m-0 px-0">
                ...
                <div class="col my-2 ml-5 mr-0 pr-0 ">
                    <div class="d-flex flex-row-reverse">
                        ...
                        <button class="btn btn-primary" type="button" style="background-color:#3366FF" onclick="verificarVenta()" value="informacion" id="boton">
                            <img src="{{ asset('img\agregar.png') }}" class="img-thumbnail" alt="Editar" width="25px" height="25px">
                            COBRAR
                        </button>
                        <!--/form-->
