        ...
        function calcula(primerNombre,apP,apM,fechaN,genero,lugarEstado) {
            var ap_paterno = apP;//"molina";
            var ap_materno = apM;//"reyes";
            var nombre = primerNombre;//"adelaida";
            var rfc = fechaN;//"970123";
            var sexo = genero;//"M";  //h =  hombre  m= mujer
            var estado = lugarEstado;//"OC";  //falta validacion de estados
            ...
            return fnCalculaCURP(nombre_f.toUpperCase(), ap_pat_f.toUpperCase(), ap_mat_f.toUpperCase(), dteNacimiento, sexo, estado);
